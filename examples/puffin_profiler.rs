...
impl TabViewer for MyContext {
    ...
    fn ui(&mut self, ui: &mut Ui, tab: &mut Self::Tab) {
        #[cfg(feature = "puffin")]
        puffin::profile_function!(tab.as_str());
...
impl MyContext {
    ...
    fn style_editor(&mut self, ui: &mut Ui) {
        ...
        ui.collapsing("DockArea Options", |ui| {
            #[cfg(feature = "puffin")]
            puffin::profile_scope!("DockArea Options");
        ...
        ui.collapsing("Separator", |ui| {
            #[cfg(feature = "puffin")]
            puffin::profile_scope!("Separator");
